...
/// <summary>
/// Options to configure the behavior of the SuperBus transport for Rebus
/// </summary>
public class SuperBusTransportOptions
{
    /// <summary>
    /// Configures whether SuperBus uses the builtin support for deferred messages which is provided
