...
namespace SuperBus.Rebus.Subscriptions;

/// <summary>
/// Subscription storage for SuperBus that uses SignalR groups for topic subscriptions
/// </summary>
internal class SuperBusSubscriptionStorage(ISignalRClient signalRClient) : ISubscriptionStorage
{
