...
/// <summary>
/// The <see cref="BoteMessage"/> is used to send data to Service Bus Queues and Topics.
/// When receiving messages, the <see cref="BoteReceivedMessage"/> is used.
/// </summary>
/// <remarks>
...
public class BoteMessage
{
    ...
    public BoteMessage(string body) :
    ...
    public BoteMessage(ReadOnlyMemory<byte> body)
    {
    ...
    public BoteMessage(BinaryData body) : this(body?.ToMemory() ?? default)
    {
    }
    ...
    //public BoteMessage(BoteReceivedMessage receivedMessage)
    //{
    ...
    //        {
    //            BoteEventSource.Log.PartitionKeyOverwritten(PartitionKey, value, MessageId);
    //            PartitionKey = value;
    //        }
    //    }
    //}
    ...
    /// data that is not exposed as top level properties in the <see cref="BoteMessage"/>.
    /// </summary>
    ...
    ///   Occurs when the <see cref="BoteMessage" /> is serialized for transport when an unsupported type is used as a property.
    /// </exception>
