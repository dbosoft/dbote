...
internal static class AmqpMessageExtensions
{
    ...
    public static BinaryData GetBody(this AmqpAnnotatedMessage message)
    {
        ...
        throw new NotSupportedException($"{message.Body.BodyType} cannot be retrieved using the {nameof(BoteMessage.Body)} property." +
                                        $"Use {nameof(BoteMessage.GetRawAmqpMessage)} to access the underlying Amqp Message object. For more information on how to avoid this error," +
