...
/// <summary>
/// The <see cref="SuperBusMessage"/> is used to send data to Service Bus Queues and Topics.
/// When receiving messages, the <see cref="SuperBusReceivedMessage"/> is used.
/// </summary>
/// <remarks>
...
public class SuperBusMessage
{
    ...
    public SuperBusMessage(string body) :
    ...
    public SuperBusMessage(ReadOnlyMemory<byte> body)
    {
        var amqpBody = new AmqpMessageBody(MessageBody.FromReadOnlyMemorySegment(body));
    ...
    public SuperBusMessage(BinaryData body) : this(body?.ToMemory() ?? default)
    {
    }
    ...
    //public SuperBusMessage(SuperBusReceivedMessage receivedMessage)
    //{
    ...
    //        {
    //            SuperBusEventSource.Log.PartitionKeyOverwritten(PartitionKey, value, MessageId);
    //            PartitionKey = value;
    //        }
    //    }
    //}
    ...
    {
        get => AmqpMessage.Properties.Subject;
        set => AmqpMessage.Properties.Subject = value;
    }
    ...
    public string? ContentType
    {
        ...
        set => AmqpMessage.Properties.ContentType = value;
    }
    ...
    public string? ReplyTo
    {
        ...
        set => AmqpMessage.Properties.ReplyTo = value == null ? null : new AmqpAddress(value);
    }
    ...
    /// data that is not exposed as top level properties in the <see cref="SuperBusMessage"/>.
    /// </summary>
    ...
    ///   Occurs when the <see cref="SuperBusMessage" /> is serialized for transport when an unsupported type is used as a property.
    /// </exception>
    public IDictionary<string, object?> ApplicationProperties => AmqpMessage.ApplicationProperties;
